<template>
  <div>
    <div class="flex flex-col text-center w-full mb-20">
      ...
      <h2 class="font-bold text-3xl lg:text-5xl tracking-tight mb-8 max-w-2xl mx-auto">
    ...
    <div class="relative flex flex-col lg:flex-row items-center lg:items-stretch gap-8">
      <div class="relative w-full">
        <div class="relative flex flex-col gap-5 lg:gap-8 z-10 bg-base-100 p-8 rounded-lg">
          <div class="flex justify-between items-center gap-4">
            <div><p class="text-lg lg:text-xl font-bold">Starter</p></div>
          </div>
          ...
          <ul class="space-y-2.5 leading-relaxed text-base flex-1">
            ...
            <li class="flex items-center gap-2">
              ...
              >
                <path
                  ...
                  clip-rule="evenodd"
                ></path></svg
              ><span class="">Stripe payments</span>
            </li>
            <li class="flex items-center gap-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <li class="flex items-center gap-2">
              <svg
                ...
                viewBox="0 0 20 20"
                fill="currentColor"
                class="w-5 h-5 text-base-content/30 shrink-0"
              >
                <path
                  d="M6.28 5.22a.75.75 0 00-1.06 1.06L8.94 10l-3.72 3.72a.75.75 0 101.06 1.06L10 11.06l3.72 3.72a.75.75 0 101.06-1.06L11.06 10l3.72-3.72a.75.75 0 00-1.06-1.06L10 8.94 6.28 5.22z"
                ></path></svg
              ><span class="text-base-content/30">ChatGPT prompts for terms &amp; privacy</span>
            </li>
            <li class="flex items-center gap-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              >
                <path
                  d="M6.28 5.22a.75.75 0 00-1.06 1.06L8.94 10l-3.72 3.72a.75.75 0 101.06 1.06L10 11.06l3.72 3.72a.75.75 0 101.06-1.06L11.06 10l3.72-3.72a.75.75 0 00-1.06-1.06L10 8.94 6.28 5.22z"
                ></path></svg
              ><span class="text-base-content/30">Discord community &amp; Leaderboard</span>
            </li>
            <li class="flex items-center gap-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              >
                <path
                  d="M6.28 5.22a.75.75 0 00-1.06 1.06L8.94 10l-3.72 3.72a.75.75 0 101.06 1.06L10 11.06l3.72 3.72a.75.75 0 101.06-1.06L11.06 10l3.72-3.72a.75.75 0 00-1.06-1.06L10 8.94 6.28 5.22z"
                ></path></svg
              ><span class="text-base-content/30">Lifetime updates</span>
            </li>
          </ul>
          <div class="space-y-2">
            <button class="btn btn-primary group btn-block" title="Go to ViteFast Checkout">
              <svg
                class="w-5 h-5 fill-primary-content group-hover:scale-110 group-hover:-rotate-3 transition-transform duration-200 ease-in-out"
                viewBox="0 0 375 509"
                xmlns="http://www.w3.org/2000/svg"
              >
                <path
            ...
            <p
              class="flex items-center justify-center gap-2 text-sm text-center text-base-content/80 font-medium relative"
            >
      ...
      <div class="relative w-full">
        ...
        <div class="absolute -inset-[1px] rounded-[8px] bg-primary z-10"></div>
        <div class="relative flex flex-col gap-5 lg:gap-8 z-10 bg-base-100 p-8 rounded-lg">
          <div class="flex justify-between items-center gap-4">
            <div><p class="text-lg lg:text-xl font-bold">All-in</p></div>
          </div>
          <div class="flex gap-2">
            <div class="flex flex-col justify-end mb-[4px] text-lg">
              <p class="relative opacity-80">
            ...
            <li class="flex items-center gap-2">
              ...
              >
                <path
                  ...
                  clip-rule="evenodd"
                ></path></svg
              ><span class="">ChatGPT prompts for terms &amp; privacy</span>
            </li>
            <li class="flex items-center gap-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <li class="flex items-center gap-2">
              ...
              ><span class=""
                >Lifetime updates<span
                  ...
                  data-tooltip-html='<div class="text-gray-300"><div class="mb-1.5 ">Latest updates on ViteFast:</div><ul><li>- <span class="text-gray-50 font-medium">(new) Compete for the Leaderboards 🥇</span> <span class="badge badge-sm">1 week ago</span></li><li>- <span class="text-gray-50 font-medium">Merge remote-tracking branch &amp;#x27;refs/remotes/ship-fast-org/main&amp;#x27;</span> <span class="badge badge-sm">1 week ago</span></li><li>- <span class="text-gray-50 font-medium">(new) Compete for the Leaderboards 🥇</span> <span class="badge badge-sm">1 week ago</span></li></ul></div>'
                  >Updated
                  <!-- -->1 week ago</span
                ></span
              >
